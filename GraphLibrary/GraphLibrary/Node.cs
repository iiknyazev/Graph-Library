...
namespace GraphsLibrary
{
    public class Node
    {
        ...
        {
            // Для оптимизации эту проверку можно убрать, если уведомить пользователя, что
            // нельзя соединять вершины уже созданного графа с вершинами вне него.
            // Экономия по времени порядка кол-ва вершин в уже созданном графе.
